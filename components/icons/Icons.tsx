...
export const ScriptIcon: React.FC<{className?: string}> = ({ className = "h-6 w-6" }) => (
...
export const GenerateIcon: React.FC<{className?: string}> = ({ className = "h-5 w-5" }) => (
...
export const LightbulbIcon: React.FC<{className?: string}> = ({ className = "h-5 w-5 text-blue-300" }) => (
  <svg {...iconProps} className={className}>
    <path strokeLinecap="round" strokeLinejoin="round" d="M12 18v-5.25m0 0a6.01 6.01 0 001.5-.184m-1.5.184a6.01 6.01 0 01-1.5-.184m3.75 3.636a9 9 0 01-1.096 2.196m1.096-2.196A9 9 0 0012 3c-3.356 0-6.402 2.176-7.608 5.168m15.216 0A9 9 0 0112 3v1.5M4.897 9.168A9 9 0 0112 3v1.5m0 15V5.25m-6.75 5.25h13.5" />
  </svg>
);
...
export const UploadCloudIcon: React.FC<{className?: string}> = ({ className = "h-5 w-5" }) => (
    <svg {...iconProps} className={className}>
...
export const ReplayIcon: React.FC<{className?: string}> = ({ className = "h-5 w-5" }) => (
    <svg {...iconProps} className={className}>
